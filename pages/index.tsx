...
const name = "Fahmi Bahtiar Adi Nugroho";
const belowLink = "Hi, I am Fahmi. I Learn on Back-End Developer";
// const bio = "Blogger | Dreamer | Observer 🗿";

const servername = "ESTETIK.ID";
          ...
          <div className="mx-auto -mt-20 flex w-full max-w-2xl flex-1 flex-col items-center px-0 sm:px-10">
            <div className="relative mb-6 flex w-full flex-col justify-center bg-opacity-90 px-2 sm:min-h-full sm:rounded-lg sm:px-6">
              <div className="flex flex-col items-center justify-center rounded-md p-2 py-4">
                ...
                <div className="mb-5 mt-1 rounded pt-2">
                  <div>
                    <div className="flex flex-row flex-wrap  items-center justify-center">
                      ...
                      <a
                        rel="noopener noreferrer nofollow"
                        target="_blank"
                        href="mailto:fahmibahtiar76@gmail.com"
                        className="flex cursor-pointer items-center justify-center rounded-full border-white border-opacity-10 bg-opacity-10 p-1.5 transition-all"
                      >
                        <svg
                          className="h-6 fill-current text-red-400 transition-all"
                          role="img"
                          viewBox="0 0 24 24"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <title>Email</title>
                          <path d="M22 4H2C1.447 4 1 4.447 1 5v14c0 .553.447 1 1 1h20c.553 0 1-.447 1-1V5c0-.553-.447-1-1-1zM3 6.5h18c.265 0 .52.105.707.293l-7.853 6.037a.997.997 0 0 1-1.208 0L2.293 6.793A.997.997 0 0 1 3 6.5zM2 19V8.618l8.621 6.235a2.978 2.978 0 0 0 3.758 0L22 8.618V19H2z"></path>
                        </svg>
                      </a>
                      ...
                      <div className="max-w-s mt-1 w-full space-y-2">
                        <div className="bg-animate group mb-1 w-full transform cursor-pointer rounded bg-gradient-to-r from-zinc-900 via-zinc-600 to-zinc-900 text-sm text-zinc-400 shadow transition-all hover:scale-105">
                          <a
                            href="/profile"
                            target="_blank"
                            rel="noopener noreferrer nofollow"
                          ...
                          >
                            <div>
                              <span className="relative mt-2 flex w-full flex-row items-center justify-between rounded bg-zinc-900 p-4 text-sm leading-tight shadow-lg transition-all duration-300 hover:bg-zinc-800">
                                <div className="flex items-center justify-center">
                                  ...
                                  <div className="mx-4 flex flex-col">
                                    <span
                                      title="Nothing"
                                      className="text-ellipsis text-lg text-zinc-400"
                                    >
                                      Personal Website
                                    </span>
                                    <span
                                      title="/profile"
                                      className="xs:w-[220px] mt-1 w-[175px] truncate text-ellipsis whitespace-nowrap text-sm text-zinc-500 sm:w-[275px] md:w-[340px] lg:w-[400px]"
                                    >
                                      About me.
                                    </span>
                                  </div>
                                </div>
                                <span className="absolute right-2 transform text-zinc-600 transition-all duration-300 hover:rotate-90 hover:text-zinc-400">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                        ...
                        <div className="relative mt-2 flex w-full transform flex-row items-center justify-between rounded-lg bg-zinc-900 p-4 text-sm leading-tight shadow-lg transition-all duration-300 hover:scale-105 hover:bg-zinc-800">
                          <div className="flex items-center">
                            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-zinc-800 bg-opacity-50">
                                ...
                                <div className="flex items-center justify-center">
                                  ...
                                  <div className="mx-4 flex flex-col">
                                    ...
                                    <span
                                      ...
                                      className="xs:w-[220px] mt-1 w-[175px] truncate text-ellipsis whitespace-nowrap text-sm text-zinc-500 sm:w-[275px] md:w-[340px] lg:w-[400px]"
                                    >
                                      community server for programmers and
                                      gamers.
                                    </span>
                                  </div>
                                </div>
                    ...
                    <div className="w-full">
                      <iframe
                        ...
                        src="https://open.spotify.com/embed/playlist/6N4vBfnINMhxHeVmm4zvEe?utm_source=generator"
                        width="100%"
                        height="352"
                        frameBorder="0"
                        // allowfullscreen=""
            ...
            <div className="flex items-center justify-center rounded-full bg-primary bg-opacity-90 text-xs font-medium text-banner">
              <footer>
                <div className="container mx-auto text-center">
                  Made by Fahmi Bahtiar
                  <p className="text-gray text-s">
                    © 2024 blimbing. All rights reserved.
                  </p>
                </div>
              </footer>
            </div>
